...
public class MainActivity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accelX = (TextView) findViewById(R.id.Accx);
        accelY = (TextView) findViewById(R.id.Accy);
        accelZ = (TextView) findViewById(R.id.Accz);
        lati = (TextView) findViewById(R.id.LatValue);
        longi = (TextView) findViewById(R.id.LongValue);

        Switch switch1 = (Switch) findViewById(R.id.startstop);
